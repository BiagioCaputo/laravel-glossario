...
class WordSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $words = [
            ...
            ['title' => 'Proprietà (width, background-color, font-family,...)', 'definition' => 'Definisce un aspetto grafico dell\'elemento o gruppo di elementi da modificare'],
            ...
            ['title' => 'Selettore di tag (p, div, h1, ....)', 'definition' => 'Seleziona tutti i tag dello stesso tipo'],
            ['title' => 'Selettore di classe (.class-name)', 'definition' => 'Seleziona tutti gli elementi appartenenti ad una classe(gruppo) definita dal programmatore'],
            ['title' => 'Selettore di ID (contrassegno "#id-name")', 'definition' => 'Seleziona un elemento univocamente contrassegnato'],
            ...
            ['title' => 'Block-level (block, inline, inline block,...)', 'definition' => 'Definisce come un elemento prende posto nella pagina: block-> occupa un intera riga / inline -> occupa lo stretto necessario su una riga'],
            ...
            ['title' => 'Float  selettore {float: valore;}', 'definition' => 'Con questa proprietà è possibile rimuovere un elemento dal normale flusso del documento e spostarlo su uno dei lati (destro o sinistro) del suo elemento contenitore. selettore {float: valore;}'],
            ...
            ['title' => ' Animation (@frame...)', 'definition' => 'Permette di definire un\'animazione da attribuire poi ad un elemento dietro specifiche: tempo di esecuzione, numero di iterazioni, ...'],
            ['title' => 'Transition (transition: nome-proprietà)', 'definition' => 'Osserva una o più proprietà di un elemento e ne definisce il comportamento al suo variare'],
